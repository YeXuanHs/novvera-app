...
class _AggregatedSearchPageState extends State<AggregatedSearchPage> {
  late final List<BookSource> sources;
  ...
  void initState() {
    ...
    this.sources = sources.map((e) => BookSource.find(e)!).toList();
...
class _SliverSearchResultState extends State<_SliverSearchResult>
  ...
  Widget buildComic(Book c) {
    return SimpleBookTile(comic: c, withTitle: true)
