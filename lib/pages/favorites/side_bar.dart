...
class _LeftBarState extends State<_LeftBar> implements FolderList {
  ...
  void findNetworkFolders() {
    // Builtin novel sources use local favorites only — never show network folders.
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              ...
              // Local only: title + all + folders. Network section omitted when empty.
              itemCount: folders.length +
                  2 +
                  (networkFolders.isEmpty ? 0 : networkFolders.length + 1),
