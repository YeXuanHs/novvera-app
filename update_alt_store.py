...
def update_json_file_release(json_file, latest_release):
    ...
    news_entry = {
        "appID": "com.github.yexuanhs.novvera",
        "caption": f"Update of Novvera just got released!",
        "date": latest_release["published_at"],
        "identifier": news_identifier,
        "notify": True,
        "tintColor": "#0784FC",
        "title": f"{full_version} - Novvera  {date_string}",
        "url": f"https://github.com/YeXuanHs/Novvera-app-desktop/releases/tag/{tag}"
    }
...
def main():
    repo_url = "YeXuanHs/Novvera-app-desktop"
